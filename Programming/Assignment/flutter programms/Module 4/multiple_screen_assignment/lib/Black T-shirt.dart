...
class Myblacktshirt extends StatelessWidget {
    ...
    return Scaffold(
        ...
        body: Column(
          children: [
            ...
            Container(
                child: Image.asset('assets/images/pic13.jpeg',height: 200,)
            ),
            SizedBox(height: 10,),
          ...
          //  Text('Single button squared cuffs',style: TextStyle( fontSize: 20,color: Colors.black),),
            ...
            Text('Product Code: 443048945071',style: TextStyle( fontSize: 20,color: Colors.black),)
          ],
        )
    );
  }
