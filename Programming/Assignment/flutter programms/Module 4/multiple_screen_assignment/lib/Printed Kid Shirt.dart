...
class Myprintedkidshirt extends StatelessWidget {
    ...
    return Scaffold(
        ...
        body: Column(
          children: [
            ...
            Container(
                child: Image.asset('assets/images/pic5.jpeg',height: 200,)
            ),
            SizedBox(height: 10,),

            Text('₹399',style: TextStyle( fontSize: 20,color: Colors.black),),
            Text('MRP ₹650 (30% off)',style: TextStyle( fontSize: 18,color: Colors.black),),
