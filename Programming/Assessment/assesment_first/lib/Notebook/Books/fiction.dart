...
import 'package:assesment_first/Notebook/Books/Models/fic_book_model.dart';
...
class _FictionState extends State<Fiction> {
  ...
  List<Map<String, String>> ficList = [];

  Future fictionbook() async {
  ...
  Widget build(BuildContext context) {
    ...
    DropdownMenuItem<String> dropdownItem(String fictionbook) =>
        DropdownMenuItem(
            value: fictionbook,
            child: Text(fictionbook, style: TextStyle(fontSize: 17),)
        );
      ...
      body: Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              SizedBox(height: 35),
              Text('Fiction Form', style: TextStyle(fontSize: 30, color: Colors.white, fontWeight: FontWeight.bold)),
              SizedBox(height: 20),
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: DropdownButton<String>(
                      ...
                      value: value,
                      underline: SizedBox(),
                      items: fic_books.map(dropdownItem).toList(),
                      onChanged: (newvalue) {
                        setState(() {
                          this.value = newvalue;
                        });
